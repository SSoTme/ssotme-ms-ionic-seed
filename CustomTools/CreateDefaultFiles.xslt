...
<body>
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                @Html.ActionLink("<xsl:value-of select="$project-name" />", "Index", "Home", new { area = "" }, new { @class = "navbar-brand" })
            </div>
    ...
    <div class="container body-content">
        ...
        <hr />
        <footer>
            <p>(c) @DateTime.Now.Year - My ASP.NET Application</p>
        </footer>
    </div>
    ...
    @RenderSection("scripts", required: false)
                ...
                <FileSetFile>
                    <RelativePath>../ionic2-ts-sidemenu1/src/index.html</RelativePath>
                    <OverwriteMode>Never</OverwriteMode>
                    <xsl:element name="FileContents" xml:space="preserve">&lt;!DOCTYPE html>
<html lang="en" dir="ltr">
<head>
  &lt;meta charset="UTF-8">
  <title><xsl:value-of select="$project-name"/> App</title>
...
<body>
  ...
  <script src="build/main.js"></script>
                ...
                <FileSetFile>
                    <RelativePath>../SSoT/UseDefaultAppStates.bat</RelativePath>
                    <FileContents>xcopy /y appstates.default.csv AppStates.csv</FileContents>
                </FileSetFile>
                <FileSetFile>
                    <RelativePath>
